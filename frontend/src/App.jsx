    ...
    {guideOpen && <div className="guide-backdrop" role="presentation" onMouseDown={event => { if (event.target === event.currentTarget) setGuideOpen(false); }}>
      <section className="guide-modal" role="dialog" aria-modal="true" aria-labelledby="guide-title">
        ...
        <div className="guide-sections">
          <article><h3>What is FogPilot?</h3><p>FogPilot is an adaptive video dehazing monitor. It improves visibility in foggy or low-contrast images and videos while tracking processing speed, quality, routing decisions, and warnings in real time.</p></article>
          <article><h3>What does FogPilot do?</h3><p>For every frame, FogPilot senses scene conditions, selects the best available dehazing algorithm, produces a clearer result, checks whether the result meets quality and speed targets, and records the outcome for the dashboard.</p></article>
